...
In an earlier post I took a look at visualizing ERPs from [two conditions at a single electrode](`r blogdown::shortcode_html("relref", '"2016-09-19-ERP-Visualization-Part-1.html"')`). This time I'm going to look at three conditions. As in the previous post, I'll assume a basic familiarity with ERPs.
...
```{r CIPlot, fig.height = 4, fig.width = 6, message = FALSE, cache = TRUE}
# basic plot setup
...
```{r diffPlotGroup, fig.height = 4, fig.width = 6, message = FALSE, cache=TRUE}
