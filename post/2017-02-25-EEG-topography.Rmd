...
I want to first of all thank **alexforrance** and **Harold Cavendish** over on [Stack Overflow](http://stackoverflow.com/questions/35019382/topoplot-in-ggplot2-2d-visualisation-of-e-g-eeg-data) for being the source of much of the code I've adapted here.
...
knitr::include_graphics("/img/MatlabTopo.png")
```
...
```{r projectElecs,fig.align='center'}
...
```{r defineTheme,message = FALSE, warning=FALSE, fig.width = 4, fig.height = 4, fig.align='center'}
...
```{r skittleFactory, warning= FALSE,fig.height = 3,fig.width=5,fig.align='center'}
...
```{r interpTopo,warning= FALSE,fig.height = 3,fig.width=5,fig.align='center'}
...
```{r matlabv4, warning = FALSE, fig.height=4, fig.align='center'}
...
```{r GAMtopoplot,warning = FALSE,fig.height= 4,fig.align='center'}
